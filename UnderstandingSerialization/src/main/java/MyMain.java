...
public class MyMain {
	public static void main(String[] args) throws Exception, IOException {
		...
		System.out.println("Before serialization a="+classToSerialize.a+",b="+classToSerialize.b+",c="+classToSerialize.c+",d="+classToSerialize.d+",e="+classToSerialize.e);
		...
		System.out.println("After serialization a="+classToSerialize2.a+",b="+classToSerialize2.b+",c="+classToSerialize2.c+",d="+classToSerialize2.d+",e="+classToSerialize2.e);
