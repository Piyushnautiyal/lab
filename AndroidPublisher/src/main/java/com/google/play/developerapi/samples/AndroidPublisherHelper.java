...
public class AndroidPublisherHelper {
	...
	private static Logger log=LogManager.getLogger(AndroidPublisherHelper.class.getName());
...
//	private static final String SRC_RESOURCES_KEY_P12 = "src/resources/key.p12";
	 ...
	 */
	private static Credential authorizeWithInstalledApplication() throws Exception {
